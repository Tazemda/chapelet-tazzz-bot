...
A) **Méditation synthèse générale en tenant un gros grain** : exactement 10 phrases moyennement denses non numérotés (toutes les méditations, tous les jours) : définition + rôle + exemple court.
